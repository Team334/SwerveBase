...
**(NOTE: This project is archived, the working swerve base is made with the CTRE project generator and exists here: [SwerveBase-CTRE](https://github.com/Team334/SwerveBase-CTRE).)**
